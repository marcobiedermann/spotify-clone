...
export const fetchArtist = (accessToken, id) => async (dispatch) => {
  const request = new Request(`${baseUrl}/v1/artists/${id}`, {
    headers: new Headers({
...
export const fetchArtistAlbums = (accessToken, id) => async (dispatch) => {
  const request = new Request(`${baseUrl}/v1/artists/${id}/albums`, {
    headers: new Headers({
      Authorization: `Bearer ${accessToken}`,
    }),
  });
...
export const fetchArtistRelatedArtists = (accessToken, id) => async (dispatch) => {
  const request = new Request(`${baseUrl}/v1/artists/${id}/related-artists`, {
    headers: new Headers({
      Authorization: `Bearer ${accessToken}`,
    }),
  });
...
export const fetchArtistTopTracks = (accessToken, id) => async (dispatch) => {
  const request = new Request(`${baseUrl}/v1/artists/${id}/top-tracks`, {
    headers: new Headers({
      Authorization: `Bearer ${accessToken}`,
    }),
  });
